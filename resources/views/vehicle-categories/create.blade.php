<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h2 class="h4 mb-0 fw-bold text-dark">Create Vehicle Category</h2>
    ...
    <div class="container-fluid px-0">
        <div class="row justify-content-center">
            <div class="col-12 col-xxl-10">
                <form method="POST" action="{{ route('vehicle-categories.store') }}" enctype="multipart/form-data">
                    @csrf
                    @include('vehicle-categories.partials.form')
